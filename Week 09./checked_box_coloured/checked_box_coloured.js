...
function setup() {
  ...
  stroke(0);
  noLoop();
  points1 = font.textToPoints('A', width/2, height/2, 500);
  points2 = font2.textToPoints('A', width/2, height/2, 500);
  points3 = font3.textToPoints('A', width/2, height/2, 500);
  points4 = font4.textToPoints('A', width/2, height/2, 500);
  points5 = font5.textToPoints('A', width/2, height/2, 500);
  points6 = font6.textToPoints('A', width/2, height/2, 500);
  points7 = font7.textToPoints('A', width/2, height/2, 500);
  points8 = font8.textToPoints('A', width/2, height/2, 500);
  points9 = font9.textToPoints('A', width/2, height/2, 500);
  points10 = font10.textToPoints('A', width/2, height/2, 500);
}
