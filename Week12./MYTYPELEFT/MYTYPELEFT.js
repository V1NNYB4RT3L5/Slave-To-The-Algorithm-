...
points10 = font10.textToPoints('A', (width/2)-253, (height/2)+255, 730, {
  ...
  text('Q.1 - How old are you?',50,130);
  text('Q.2 - What size are you?',50,210);
  text('Q.3 - What is your favourite pet?',50,290);
  text('Q.4 - What do you prefer to eat?',50,370);
  text('Q.5 - What do you do with your Money?',50,450);
}
...
if (valC == 'Cat'){
  fill(255);
  rectMode(CORNERS);
  rect(windowWidth/2-300,windowHeight/2-55,windowWidth/2+300, windowHeight/2+55);
  fill(0);
  beginShape();
...
if (valE == 'Spend'){
  fill(255);
  rectMode(CORNERS);
  rect(windowWidth/2-300,windowHeight/2+155,windowWidth/2+300, windowHeight/2+260);
  stroke(0);
  line(0,windowHeight/2+255,windowWidth,windowHeight/2+255);
  noStroke();
  fill(0);
